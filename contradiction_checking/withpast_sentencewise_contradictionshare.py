...
if __name__ == "__main__":
    ...
    with open(f"../results/threshold/{consultation_prefix}_nli/{input_model_name}{('_' + input_model_revision) if input_model_revision != 'main' else ''}/withpast_sentencewise_contradictionshare.log", "r", encoding="utf8") as file:
