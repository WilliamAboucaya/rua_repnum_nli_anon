...
# Lint as: python3
"""RepNum NLI without past sentences"""
...
from utils.functions import get_original_proposal_repnum, remove_past_sentences
...
class RepNumNliNoPastConfig(datasets.BuilderConfig):
    ...
    def __init__(self, **kwargs):
        ...
        """
        super(RepNumNliNoPastConfig, self).__init__(**kwargs)


class RepNumNliNoPast(datasets.GeneratorBasedBuilder):
    """XNLI: The Cross-Lingual NLI Corpus. Version 1.0."""

    VERSION = datasets.Version("1.0.0", "")
    BUILDER_CONFIG_CLASS = RepNumNliNoPastConfig
    BUILDER_CONFIGS = [
        RepNumNliNoPastConfig(
            name="3_classes",
            version=datasets.Version("1.0.0", ""),
